...
class TestIntegration:
    ...
    def test_list_voices_cli(self):
        ...
        # dog_bark might not be available in CI environment, so don't test for it
    ...
    def test_list_voices_detailed_cli(self):
        ...
        assert result.returncode == 0
        # Check CW built-in voice information
        assert "CW (built-in)" in result.stdout
        ...
        # Dog bark voice might not be available in CI environment
